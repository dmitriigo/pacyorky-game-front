<template>
	<b-modal
		...
		header-class="justify-content-end modal-header"
		footer-class="justify-content-center modal-footer"
	>
		<template #modal-header>
			<b-button @click="close" class="removeDefaultButtonStyle">
					...
					<b-row class="d-flex justify-content-center pt-2">
						<b-col cols="2" class="px-0 d-flex justify-content-center">
							<b-button
								...
								class="removeDefaultButtonStyle"
							>
		...
		<template #modal-footer="{ ok }">
			<b-button @click="onSubmit" class="submitGameCreateBtn mb-5 mt-4">
